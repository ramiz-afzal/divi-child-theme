...
if (!class_exists('ET_CT_INIT')) {
    class ET_CT_INIT
    {
        ...
        public function et_ct_disable_emojis_remove_dns_prefetch($urls, $relation_type)
        {
        ...
        public function et_ct_include_header_scripts()
        {
            $header_scripts = get_option('et_ct_header_scripts', '');
            echo $header_scripts;
        }

        public function et_ct_include_footer_scripts()
        {
            $footer_scripts = get_option('et_ct_footer_scripts', '');
            echo $footer_scripts;
        }
    }
}
